// const allSeasonsDestModel = require('../models/allSeasonsDestination');
...
//           const totalDestination = await allSeasonsDestModel.countDocuments();
...
//     try {
//         const destination = await allSeasonsDestModel.findById(id);
...
//     const newDestination = new allSeasonsDestModel({
...
//         const results = await allSeasonsDestModel.findByIdAndUpdate(id, updateData, options);
...
//     try {
//         const destination = await allSeasonsDestModel.findByIdAndDelete(id);
